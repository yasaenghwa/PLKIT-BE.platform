...
async def update_market(
    ...
    특정 마켓 게시물을 수정합니다.
    """
    updated_market = crud.market.update_market(db, market_id, market_update)
...
async def upload_market_image(market_id: int, file: UploadFile = File(...), db: Session = Depends(get_db)):
    """
